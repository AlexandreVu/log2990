...
export class Server {
    ...
    public init(): void {
        ...
        this.socket = new SocketService(this.server);
    }
    ...
    private  onListening(): void {
        ...
        // tslint:disable-next-line:no-console --> afin d'afficher dans le terminal du serveur quand est-ce que le serveur est fonctionnel
